...
그다음, 오늘 비교를 통해 발견한 개선점을 1개, 정말 필요한 경우에만 최대 2개까지 (1), (2) 소제목으로 제시하고, 각각 2~3문장 이내로 간결하게 서술하십시오. 
항목을 억지로 늘리지 말 것.]
2) 실행 지시
[※ AI 통변 지시: 위에서 제시한 각 개선점에 대응하여, 개발자가 실제로 `prompts.py` 또는 `engine.py`에 반영할 수 있는 실행 지시를 ▶ 기호로 한 줄씩 제시하십시오. 
"실행 지시"라는 단어를 반복해서 쓰지 말고, 곧바로 어느 파일의 무엇을 어떻게 바꾸라는 것인지 구체적인 문장으로 작성할 것. 
