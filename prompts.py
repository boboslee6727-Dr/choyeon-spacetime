...
일주, 격국, 십성, 신살, 공망 등 전문 용어를 순화 없이 그대로 노출할 것.
■ 간지(干支)를 언급할 때는 반드시 한자(甲, 乙, 丙, 子, 丑, 寅 등)로만 표기하고, "축(丑)"처럼 한글 발음을 병기하지 말 것. 
오직 한자 한 글자로만 표기할 것. 특히 일주는 한자 간지로 표기할 것.
...
또한, 일주, 대운, 세운 등은 한자 간지(甲寅 등)로 표기할 것.
