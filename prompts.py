...
■ 타 감명서 원문 안에 별도의 인물/사례(예: 다른 사람의 사망 사례, 다른 명조)가 언급되어 있다면, 이를 신청자 본인의 사주 정보와 절대 혼동하지 말 것. 
원문 속 사례가 신청자와 같은 대운/세운에 있는 것처럼 서술하지 말고, "원저자가 제시한 예시 사례"로 명확히 구분하여 언급할 것. 신청자 본인의 대운/세운/나이는 오직 위에 제공된 사주 팩트 데이터만을 근거로 할 것.
