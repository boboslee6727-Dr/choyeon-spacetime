...
■ 영어 모듈명, "Phase 1/2/3", 수식, 의사코드, "Index"류 영어 조어를 절대 창작하지 말 것. 모든 서술은 순수 한글 문장으로만 작성할 것.
...
🚨 [본 상품 전용 - 맺음말 생략 지시]
■ 본 상품은 연구자 본인만 열람하는 비공개 학술 검증 도구이므로, 고객용 맺음말이나 인사말, 축복 문구를 절대 작성하지 말 것. 3번 대목차의 마지막 문장으로 바로 끝낼 것.
