...
<p style='margin-bottom: 12px; text-indent: 15px;'>
    f"{{disp_name}}님은 일간 {{ds}}의 본질을 바탕으로, 사회적으로는 {{s12_str}} 및 {{shinsal_str}}의 기운이 어우러져 {{사회적 페르소나 성향}}이라는 독특한 분위기를 자아냅니다."
    내면의 일지 지장간 속에 숨겨진 세 가지 기운은 {disp_name}님을 더욱 입체적으로 빚어냅니다. 
    먼저 초기(여기)의 {지장간1_십성} 기운은 {지장간1_설명} 성향을 부여하며 <b>({지장간1_십성}, {지장간1_좌}좌, {지장간1_궁}궁)</b>, 
    이어지는 중기의 {지장간2_십성} 기운은 {지장간2_설명} 기질로 나타납니다 <b>({지장간2_십성}, {지장간2_좌}좌, {지장간2_궁}궁)</b>. 
    마지막으로 정기(본기)인 {지장간3_십성}은 {지장간3_설명} 모습으로 중심을 잡아 {disp_name}님만의 견고한 성격적 체계를 완성합니다 <b>({지장간3_십성}, {지장간3_좌}좌, {지장간3_궁}궁)</b>".
</p>

<span class='sub-title' style='font-size: 18px; font-weight: 900; color: #111; display: block; margin-top: 20px;'>2) 감추어진 내 속마음</span>
<p style='margin-bottom: 12px; text-indent: 15px;'>
     f"겉으로 보이는 듬직한 모습 너머, {disp_name}님의 마음 한구석에는 채워지지 않은 특별한 갈망이 있습니다. 
    원국에서 인종하여 살펴본 {인종법1_십성}의 기운은 {인종법1_설명}이라는 형태로 삶의 보이지 않는 동력이 되며 <b>({인종법1_십성}, {인종법1_종}종, {인종법1_궁}궁)</b>, 
    {인종법2_십성}의 에너지는 {인종법2_설명}이라는 갈망으로 투영됩니다 <b>({인종법2_십성}, {인종법2_종}종, {인종법2_궁}궁)</b>. 
    또한 {gongmang_actual} 공망의 영역은 비록 현실적 결핍을 의미할 수 있으나, 오히려 {공망에 대한 위로와 조언}을 통해 더욱 깊은 내면의 성장을 도모하라는 하늘의 가르침이기도 합니다."
</p>
</div>
