...
# 🎯 [버전 컨트롤 타워]
APP_VERSION = "Ver 38.0 (Gemini 2.5-Pro Mode)"
...
"""
    ...
    <span style='font-weight: 900; font-size: 18px; color: #1A237E;'>- 초연 시공명리 연구소 드림 -</span>
                ...
                if u_product in ["개인사주", "타 감명서"]:
                    ...
                    (🚨 중요: 글씨를 굵게 강조할 때 마크다운 별표(**)는 절대 사용하지 말고, 반드시 HTML <b> 태그만 사용하십시오.)
                    <ul style='line-height: 2.0; font-size: 15px;'>
                        <li><b>과거 대운 (예: 3세~12세 대운):</b> (지나온 대운의 핵심 요약)</li>
                        <li><b>현재 대운(大運)의 흐름:</b> (현재 10년 단위의 거시적 운세 흐름과 환경 변화를 상세히 풀이)</li>
