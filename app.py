        ...
        try:
            ...
            if u_product in ["개인사주", "궁합", "타 감명서"]:
                ...
                cover_html = (
                        ...
                        f"                <span style='font-size: 14px; color: #555; font-weight: 600; letter-spacing: 1px; font-family: \"Malgun Gothic\", \"Apple SD Gothic Neo\", sans-serif !important;'>{APP_VERSION}</span>\n"
                        f"            </div>\n"
                        f"        </div>\n"
