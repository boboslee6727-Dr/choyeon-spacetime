...
st.markdown("""<style>
    ...
    /* 🎯 합충형파해 내부 가로 줄눈 흔적 없이 완전 삭제 전용 클래스 선언 */
    ...
    /* 🎯 운의 흐름표 테이블 하단 쓸데없는 공백(마진/패딩) 싹쓸이 압축 밀착 */
    ...
    /* 🎯 사주팔자 역산 검색기 아코디언 메뉴 정품 남색 고정 복원 */
...
# ==============================================================================
# 5. 제어 사이드바 입력창 구현 구역 (중복 레이블 '상대방' 단어 전면 제거 완료)
# ==============================================================================
with st.sidebar:
...
"""
            ...
            # ==============================================================================
            # [6-3] 🔴 프리미엄 종합 궁합 모드 구역 (남녀 위아래 완벽 정렬 렌더링 가동)
            # ==============================================================================
            elif u_product == "궁합":
