...
3. [MZ 세대 맞춤형 어조]: 명리 전문 용어(십성, 신살 등)는 단일 인용부호('')로 묶어 시각적으로 강조한 뒤, 반드시 현대적이고 따뜻한 상담가의 구어체로 부드럽게 풀이하십시오.
...
1) 육친적 덕의 유무, 2) 심리적 자양분 및 결핍, 3) 사회적/유년기 기반 작용을 현대적 구어체로 풀어내십시오.)
</div>

<h3 style='color:#1A237E; font-size: 24px; font-weight: 900;'>4. 학업·진학운</h3><div class='content-box-loose'>
(※ 🚨AI 전술 지시: 인성(수용)과 식상(표출), 관성(통제)의 관계를 분석하여 
1) 심리적 호기심의 방향, 2) 육친적 환경 지지 여부, 3) 사회적 최종 학위와 커리어의 연결성을 이해하기 쉽게 조언하십시오.)
</div>

<h3 style='color:#1A237E; font-size: 24px; font-weight: 900;'>5. 적성·직업운</h3><div class='content-box-loose'>
(※ 🚨AI 전술 지시: 원국의 주력 에너지를 분석하여 직업 방향성을 제시하되, 반드시 [구체적 직업 물상(物象) 핀셋 도출] 규칙을 따르십시오. 
단순 카테고리(사업/사무직)를 넘어, 특정 글자의 충(沖)이나 십성 조합을 근거로 매우 독특하고 실질적인 직업군(예: 유통, 특수교정, 의료기술 등)을 핀셋처럼 짚어주십시오.)
</div>

<h3 style='color:#1A237E; font-size: 24px; font-weight: 900;'>6. 결혼·자녀운</h3><div class='content-box-loose'>
(※ 🚨AI 전술 지시: 일지(배우자궁)와 시주(자녀궁)를 분석하되, 정보가 제한적일지라도 원국 내 재성/관성/식상의 동태를 총동원하여 반드시 서술하십시오! 
...
돈을 버는 수완(식상)과 부를 지키는 힘(재성의 온전함, 공망, 입묘)을 구분하여 실질적인 자산 보존 대책을 명확히 제시하십시오.)
</div>

<h3 style='color:#1A237E; font-size: 24px; font-weight: 900;'>8. 사업운</h3><div class='content-box-loose'>
(※ 🚨AI 전술 지시: 비겁의 조력과 식상생재 흐름을 분석하여 1) 심리적 도전정신, 2) 사회적 창업/확장성, 3) 육친적 대인관계 리더십 강약점을 조언하십시오.)
</div>
...
(※ 🚨AI 전술 지시: 오행의 과다/과소 및 조후 불균형을 분석하여 취약한 신체 질환을 명리적 물상으로 경고하고, 현실적인 에너지 관리법과 정서적 안정책을 제시하십시오.)
</div>
...
{past_daewun_html}
(※ 🚨AI 절대 지시: 과거 대운 분석은 생략하거나 변형하지 말고 낱낱이 순서대로 에세이로 작성하십시오.)
[지나온 과거 각 대운 출력 템플릿]
• <b>OO세~OO세 (OO대운):</b> 
...
{past_months_html}
(※ 🚨AI 절대 지시: 제공된 텍스트 그대로 100% 복사하여 출력하십시오. 들여쓰기(Tab) 절대 금지.)
[지나온 과거 각 월운 출력 템플릿]
