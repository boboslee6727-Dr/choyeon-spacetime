...
<p style='margin-bottom: 12px; text-indent: 15px;'>
    {disp_name}님은 일간 {ds}의 본질을 바탕으로, 사회적으로는 {s12_str} 및 {shinsal_str}의 기운이 어우러져 {사회적 페르소나 성향}이라는 독특한 분위기를 자아냅니다. 
...
<p style='margin-bottom: 12px; text-indent: 15px;'>
    겉으로 보이는 듬직한 모습 너머, {disp_name}님의 마음 한구석에는 채워지지 않은 특별한 갈망이 있습니다. 
