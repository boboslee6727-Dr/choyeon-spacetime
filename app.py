...
# 🎯 [버전 컨트롤 타워]
APP_VERSION = "Ver 39.0 (Gemini 2.5-Pro Mode)"
...
<h3 style='color:#1A237E; font-size: 24px; font-weight: 900;'>11. 운의 흐름</h3>
    ...
    3. 통변 근거 제시 시 반드시 명리적 근거(십성, 합형충파해, 신살 등)를 기반으로 논증하십시오. (🔥 그대로 유지!)
    4. (유연한 목차 구성) 타 감명서의 목차와 논리 흐름을 면밀히 분석하여, 해당 감명서가 다루고 있는 핵심 주제들에 맞추어 AI가 유연하게 비교 항목(목차)을 도출하십시오. (🔥 고정 목차 대체!)

    5. 🚨 [초연 시공명리 분석 주도권 및 혹독한 상호 비판 지침 - 엄격 준수]
       ...
       - 🚨 [총평의 주객전도 방지 및 혹독한 피드백 규칙]: 마지막 '총평 및 향후 개선점' 목차에서는 상호보완이라는 온정주의적 물타기를 전면 금지합니다. 양측 감명서의 장단점을 지극히 냉정하고 혹독하게(Strictly & Harshly) 지적하십시오.
         * <타 감명>에 대해서는 단편적 십성 고착화에 따른 기계적 짜맞추기, 공포 마케팅식 사건 단정, 시공간적 역동성 상실 등 전통 명리의 치명적인 한계를 송곳처럼 찌르십시오.
         * <초연>에 대해서는 타 감명서와의 대조를 통해 **'우리의 프롬프트(엔진)를 더 강력하게 업그레이드하기 위해 반드시 보완해야 할 서술적 약점과 누락된 명리 요소'**를 아주 냉혹하게 찾아내어 기술하십시오. (예: 타 감명서가 짚어낸 구체적인 형살 발동 타이밍, 특수 신살의 활용, 구체적인 물상대체/테크 제안 등에서 초연의 프롬프트가 보강해야 할 점을 명확한 '개선 청구서' 형태로 도출할 것).
