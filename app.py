...
<span style='font-weight: 900; font-size: 18px; color: #1A237E;'>- 초연 시공명리 연구소 드림 -</span>
                ...
                age_prompt = ""
                if u_age < 20:
                    age_prompt = "내담자는 [청소년기(10대)]입니다. '4. 학업·진학운' and '3. 부모·형제운'을 최우선으로 가장 상세히 분석하고, 재성운(재물)/사업운은 간략히 축소하십시오."
                elif 20 <= u_age < 40:
                    age_prompt = "내담자는 [청년기(20~30대)]입니다. '5. 적성·직업운' and '6. 결혼·자녀운' 등 사회적 자립과 연애/혼인 과정을 상세히 통변하십시오."
                elif 40 <= u_age < 60:
                    age_prompt = "내담자는 [중장년기(40~50대)]입니다. 인생의 황금기이므로 '9. 재성운(재물)' and '8. 관직·명예운(사업/승진)'에 통변의 화력을 집중하여 가장 길고 상세하게 서술하십시오."
                else:
                ...
                if u_gender == "남성":
                    ...
                    gender_prompt = "내담자는 [여성]입니다. 육친 해석 시식상(자녀/표현력)과 관성(남편/직장)의 조화를 중심으로 풀되, 현대 사회 여성의 독립적 사회 활동และ 성취를 비중 있게 강조하십시오."
                ...
                # 🎯 [메모리에 상주한 choyeon_db 변수에서 자의형상 추출]
                w_key = f"{ms}{mb}월"
                i_key = f"{ds}{db}"
...
사주 구조의 핵심을 나타내는 격국(格局)은 <b>{gyukgook_detail}</b></p>
"""
