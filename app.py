...
<p style='margin-bottom: 12px; text-indent: 15px;'>
    {disp_name}님은 일간 {ds}의 본질을 바탕으로, 사회적으로는 {s12_str} 및 {shinsal_str}의 기운이 어우러져 {사회적_페르소나_성향}이라는 독특한 분위기를 자아냅니다. 
...
<p style='margin-bottom: 12px; text-indent: 15px;'>
    ...
    또한 {gongmang_actual} 공망의 영역은 비록 현실적 결핍을 의미할 수 있으나, 오히려 {공망_위로_조언}을 통해 더욱 깊은 내면의 성장을 도모하라는 하늘의 가르침이기도 합니다.
</p>
"""
