...
if st.session_state.get('app_running', False):
    ...
    with st.spinner(spinner_msg):
        ...
        if u_product.startswith("1-1"): report_title = "🏮 사주팔자 정밀 운세풀이"
        elif u_product.startswith("1-2"): report_title = "🏮 연간 운세 정밀 분석"
        elif u_product.startswith("1-3"): report_title = "🏮 월간 운세 정밀 분석"
        elif u_product.startswith("1-4"): report_title = "🏮 주간·일일 운세 분석"
        ...
        elif u_product.startswith("2-5"): report_title = "🏮 이사·개업 길일 택일"
        
        elif u_product.startswith("3-1"): report_title = "🏮 커플 궁합 정밀 분석"
        elif u_product.startswith("3-2"): report_title = "🏮 결혼 길일 추천 리포트"
        elif u_product.startswith("3-3"): report_title = "🏮 출산 길일 추천 리포트"
        
        elif u_product.startswith("4-1"): report_title = "🏮 사주 감명서 비교 분석"
        elif u_product.startswith("4-2"): report_title = "🏮 궁합 감명서 비교 분석"
        else: report_title = "🏮 초연 사주팔자 정밀 분석"
